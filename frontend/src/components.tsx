...
import { useMultiSeries } from "./series";
...
// The single component→renderer mapping shared by the deployed app and the
// builder preview. Both render identically from the same manifest.
